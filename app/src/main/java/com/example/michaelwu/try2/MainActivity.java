...
public class MainActivity extends AppCompatActivity
    ...
    private final String SECURE = "Secured";
    private final String UNSECURE = "Unsecure";
    DrawerLayout drawer;
    ...
    private void setListener() {
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(statusText.getText().equals("Unsecure")){
    ...
    private void wireWidgets() {
        ...
        fab = (FloatingActionButton) findViewById(R.id.power_button);
